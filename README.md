...
*   [Módulo de Configuración de Inventario (README_INVENTORY.md)](./README_INVENTORY.md) - Creación y gestión de categorías, subcategorías, campos personalizados y elementos físicos del inventario.
...
*   [Módulo de Inventario Asignado (README_ASSIGNED_INVENTORY.md)](./README_ASSIGNED_INVENTORY.md) - Consulta global de inventario asignado al docente a través de sus espacios físicos, con filtros avanzados de categoría, subcategoría, aula y jornada.
